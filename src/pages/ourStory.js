    ...
    <>
      ...
      <main className="flex w-full flex-col items-center justify-center dark:text-light">
        <Layout className="pt-16">
          <AnimatedText text="Our Story!" className="mb-16 lg:!text-6xl sm:!text-6xl  xs:!text-2l
          ...
          <div className="grid w-full grid-cols-8 gap-16 sm:gap-8">
            ...
            bg-light p-8 dark:bg-dark dark:border-light xl:col-span-4 md:order-1 md:col-span-8 sm:w-[60%] sm:rounded-lg xs:w-[70%] xs:rounded-md"
            >
            ...
            <div className="col-span-2 flex flex-col items-end justify-between xl:col-span-8 xl:flex-row xl:items-center md:order-3 sm:flex-col">
