...
//         justify-betwwn bg-light  text-dark dark:bg-dark dark:text-light first:mt-0 border border-solid border-dark dark:border-light
  ...
  />
          ...
          <div className="contact-box">
            ...
            <div>
              ...
              <textarea id="w3review" name="w3review" rows="4" cols="50" placeholder="Enter Your Message" className="message">
